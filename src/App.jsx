  ...
  const renderLogin = () => (
    <div className="fade-in-up flex min-h-screen w-full flex-col items-center justify-center gap-6 p-4">
      <div className="flex items-center justify-center gap-5">
        <img src="public/mpk.png" alt="Logo MPK SMA Negeri 13 Pontianak" className="h-14 w-14 object-contain sm:h-16 sm:w-16" />
        <img src="public/smantas.png" alt="Logo SMA Negeri 13 Pontianak" className="h-14 w-14 object-contain sm:h-16 sm:w-16" />
        <img src="public/osis.png" alt="Logo OSIS SMANTAS" className="h-14 w-14 object-contain sm:h-16 sm:w-16" />
      </div>
