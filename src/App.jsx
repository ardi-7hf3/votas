  ...
  const renderLogin = () => (
    <div className="fade-in-up flex min-h-screen w-full flex-col items-center justify-center gap-6 p-4">
      <div className="flex items-center justify-center gap-5">
        <img src="/mpk.png" alt="Logo MPK SMA Negeri 13 Pontianak" className="h-14 w-auto sm:h-16" />
        <img src="/smantas.png" alt="Logo SMA Negeri 13 Pontianak" className="h-14 w-auto sm:h-16" />
        <img src="/osis.png" alt="Logo OSIS SMANTAS" className="h-14 w-auto sm:h-16" />
      </div>
